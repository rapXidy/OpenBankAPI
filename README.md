...
<li>Hashing and salting of user account passwords in the db. </li>
<li><strong>Do not store user passwords in plain text!!</strong></li>
<li>etc...</li>
</ol>

<p>more amazing endpoints would be added as time goes on.</p>
<strong>Kindly update the connection String in the appSettings.json file to your own local db before running or building</strong>
### UI/UX ###
...
<img src = "Images/SwaggerUI_ofBankAPI3.png" width="900" height="600" >
<img src = "Images/SwaggerUI_ofBankAPI4.png" width="900" height="600" >
<img src = "Images/SwaggerUI_ofBankAPI5.png" width="900" height="600" >
<img src = "Images/SwaggerUI_ofBankAPI6.png" width="900" height="600" >
<img src = "Images/SwaggerUI_ofBankAPI7.png" width="900" height="600" >
